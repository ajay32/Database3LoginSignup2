...
import com.hackingbuzz.databaseloginsignup.helpers.InputValidation;
...
public class LoginScreen extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        et_name2 = (EditText) findViewById(R.id.et_name);
    ...
    private void verifyFromSQLite() {
        ...
        if (databaseHelper.checkUser(et_email.getText().toString().trim()
            ...
            Intent accountsIntent = new Intent(activity, LeftNavigationActivity.class);
            emptyInputEditText();
